...
class FeedbackResult {
    ...
    public function fetchRoomDetails($id) {
        ...
        $queryRoomDetails = "SELECT 
                            book_room.registrationno_id,
                            ...
                            WHERE book_room.registration_no = '$id'";

        $result = mysqli_query($this->conn, $queryRoomDetails);
    ...
    public function fetchFeedback($registrationNo) {
        ...
        $result = mysqli_query($this->conn, $queryFeedback);
    ...
    public function fetchAdminName($getEmail) {
        $queryName = "SELECT username FROM admin_login WHERE admin_email = '$getEmail'";

        $result = mysqli_query($this->conn, $queryName);
...
$feedbackResult = new FeedbackResult($conn);

$roomDetails = $feedbackResult->fetchRoomDetails($id);
$getRegistrationNo = isset($roomDetails[0]['registration_no']) ? $roomDetails[0]['registration_no'] : null;

$feedbacks = $feedbackResult->fetchFeedback($getRegistrationNo);
$fullName = $feedbackResult->fetchAdminName($_SESSION["email"]);
...
<body>
    ...
    <div class="main">
        ...
        <div class="maincontent">
            ...
            <p id="userlogin">Room and Feedback Details</p>
            <hr>
                ...
                <div class="box">
                    ...
                    <div class="boxinfo">
                        ...
                        <table border="1" cellspacing="0">
                            <thead>
                                <tr>
                                    <th colspan="6" class="blue bigger">Feedback Details</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($feedbacks as $row) : ?>
                                <tr>
                                    <td class="bold">Feedback ID :</td>
                                    <td><?= $row["feedback_id"]; ?></td>
                                </tr>
                                <tr>
                                    <td class="bold">Accessibility to Warden :</td>
                                    <td><?= $row["accessibility_to_warden"]; ?></td>
                                </tr>
                                <tr>
                                    <td class="bold">Accessibility to Hostel Committee Members :</td>
                                    <td><?= $row["accessibility_to_hostel_committee_members"]; ?></td>
                                </tr>
                                <tr>
                                    <td class="bold">Redressal of Problems :</td>
                                    <td><?= $row["redressal_of_problems"]; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="bold">Mess :</td>
                                    <td><?= $row["mess"]; ?></td>
                                </tr>
                                <tr>
                                    <td class="bold">Hostel Surroundings :</td>
                                    <td><?= $row["hostel_surroundings"]; ?></td>
                                </tr>
                                <tr>
                                    <td class="bold">Overall Rating :</td>
                                    <td><?= $row["overall_rating"]; ?></td>
                                </tr>
                                <tr>
                                    <td class="bold">Feedback Message :</td>
