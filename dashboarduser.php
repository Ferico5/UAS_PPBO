...
$dashboardUser = new DashboardUser($conn);

$fullName = $dashboardUser->getUserName($getEmail);
        ...
        <div class="navbar">
            ...
            <div class="contentnavbar">
                ...
                <div class="textnavbar">
                    ...
                    <a href="mycomplaint.php"><p>Registered Complaints</p></a>
                    <a href="feedback.php"><p id="feeconnack">Feedback</p></a>
        ...
        <div class="maincontent">
            ...
            <div class="containermain">
                <div class="containersub">
                    <div class="contentsub" id="my_profile">
                        <p>My Profile</p>
                    </div>
                    <div class="fullinfo">
                        <a href="profile.php"><p>FULL DETAIL</p></a>
                    </div>
                </div>
                <div class="containersub" id="top_for_responsive">
                    <div class="contentsub" id="my_room">
                        <p>My Room</p>
                    </div>
                    <div class="fullinfo">
                        <a href="roomdetail.php"><p>FULL DETAIL</p></a>
                    </div>
                </div>
            </div>
        </div>
