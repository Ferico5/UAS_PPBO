...
class StudentsData {
    ...
    // Method untuk mendapatkan daftar students
    public function getStudentData() {
        $queryComplaints = "SELECT registration_no, full_name, gender, contact_no, email FROM registration";
...
$studentsData->checkAdminLogin();
$fullName = $studentsData->getAdminName();
$complaints = $studentsData->getStudentData();
$studentsData->closeConnection();
...
<body>
    ...
    <div class="main">
        ...
        <div class="maincontent">
            ...
            <p id="userlogin">Students' Data</p>
            <hr>
                    ...
                    <div class="boxinfo">
                        <table border="1" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td id="center"><?= $i; ?></td>
                                    <td id="center"><?= $row["registration_no"]; ?></td>
                                    <td><?= $row["full_name"]; ?></td>
                                    <td><?= $row["gender"]; ?></td>
