...
// get admin email yang sedang login
...
class AddAdmin {
    ...
    public function getMaxAdminId() {
        $sql_max_admin_id = "SELECT MAX(admin_id) AS max_admin_id FROM admin_login";
        $result_max_admin_id = $this->conn->query($sql_max_admin_id);
        $row_max_admin_id = $result_max_admin_id->fetch_assoc();
        return $row_max_admin_id['max_admin_id'] + 1;
    }
...
// Mendapatkan nilai maksimum admin_id untuk admin baru
$next_admin_id = $addAdmin->getMaxAdminId();
...
// get nama admin
$fullName = $addAdmin->getAdminName($getEmail);
        ...
        <div class="maincontent">
            ...
            <div class="formcontainer">
                ...
                <form class="form" method="post">
                    <div class="fillform">
                            <p>Admin Id : <input type="text" name="admin_id" id="admin_id" value="<?php echo $next_admin_id; ?>" readonly></p>
                            <p>Username: <input type="text" name="username" id="username" required></p>
                            <p>Admin Email: <input type="email" name="admin_email" id="admin_email" required></p>
                            <p>Admin Password: <input type="password" name="password" id="password" required></p>
                            <p>Confirm Admin Password: <input type="password" name="confirmPassword" id="confirmPassword" required></p>
                            <p id="error-message" style="display:none; color:red;">Passwords do not match!</p>

                        <div class="buttonform">
                            <button type="reset"><a href="dashboardadmin.php">Cancel</a></button>
                            <button type="submit" id="submit">Add Admin</button>
                        </div>
                    </div>
                </form>
            </div>
