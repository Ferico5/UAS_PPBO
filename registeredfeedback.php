...
class FeedbackManager {
    ...
    public function getFeedbackData() {
        ...
        $query2 = mysqli_query($this->conn, "SELECT
                                ...
                                feedback.registration_no,
                                registration.full_name,
                                book_room.room_no 
                                FROM feedback
                                JOIN registration ON registration.registration_no = feedback.registration_no
                                JOIN book_room ON book_room.registration_no = feedback.registration_no");
...
$result = $feedbackManager->getFeedbackData();
$fullName = $feedbackManager->getAdminName();
...
<body>
    ...
    <div class="main">
        ...
        <div class="maincontent">
            ...
            <p id="userlogin">Registered Feedback</p>
            <hr>
                        ...
                        <table border="1" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="center"><a href="feedbackresult.php?id=<?php echo $row['registration_no']; ?>"><button>Action</button></a></td>
                                </tr>
                                <?php $i++; ?>
                                <?php endforeach; ?>
                            </tbody>
