...
class InProcessComplaint {
    ...
    public function getInProcessComplaints() {
        $status = mysqli_real_escape_string($this->conn, "In Process");
...
$inProcessComplaint = new InProcessComplaint($conn);
...
<body>
    ...
    <div class="main">
        ...
        <div class="maincontent">
            ...
            <p id="userlogin">In Process Complaints</p>
            <hr>
