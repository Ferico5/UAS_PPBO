...
class PasswordHandler {
    ...
    public function getCurrentPassword() {
        ...
        $query = "SELECT password FROM registration WHERE email = '$getEmail'";
    ...
    public function updatePassword($newPassword, $confirmNewPassword) {
        $getEmail = mysqli_real_escape_string($this->conn, $this->email);
        $newPassword = mysqli_real_escape_string($this->conn, $newPassword);
        $confirmNewPassword = mysqli_real_escape_string($this->conn, $confirmNewPassword);

        if ($newPassword === $confirmNewPassword) {
            $updateQuery = "UPDATE registration SET password='$newPassword' WHERE email='$getEmail'";
    ...
    public function getFullName() {
        ...
        $query = "SELECT full_name FROM registration WHERE email = '$getEmail'";
        $result = mysqli_query($this->conn, $query);
...
$passwordHandler = new PasswordHandler($conn, $getEmail);

// Ambil password saat ini
$storedPassword = $passwordHandler->getCurrentPassword();

// Jika form disubmit, proses update password
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($currentPassword === $storedPassword) {
        $passwordHandler->updatePassword($newPassword, $confirmNewPassword);
    } else {
...
$fullName = $passwordHandler->getFullName();
...
<body>
    ...
    <div class="main">
        ...
        <div class="maincontent">
            ...
            <p id="userlogin">Change Password</p>
            <hr>
