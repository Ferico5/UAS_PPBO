...
class MyComplaint {
    ...
    private function fetchRegistrationDetails() {
    ...
    public function getComplaints() {
        $query = mysqli_query($this->conn, "SELECT
                                            ...
                                            WHERE registration_no = '$this->registrationNo'");
...
$myComplaint = new MyComplaint($conn, $getEmail);

// Ambil data complaint dan nama
$complaints = $myComplaint->getComplaints();
$fullName = $myComplaint->getFullName();
...
<body>
    ...
    <div class="main">
        ...
        <div class="maincontent">
            ...
            <p id="userlogin">My Complaints</p>
            <hr>
                        ...
                        <table border="1" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="center"><a href="complaintaction.php?id=<?php echo $row['register_complaint_id']; ?>"><button>Action</button></a></td>
                                </tr>
                                <?php $i++; ?>
                                <?php endforeach; ?>
                            </tbody>
